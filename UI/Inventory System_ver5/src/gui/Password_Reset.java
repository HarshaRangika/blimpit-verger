...
public class Password_Reset extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_validation.setForeground(new java.awt.Color(204, 0, 0));
        lbl_validation.setText("Please Enter Valide Password");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(jPasswordField2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(29, 29, 29))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            try {
                jsonObjectPassword.put("username","admin");
                jsonObjectPassword.put("password",client.encrypt(Password2));
            } catch (UnsupportedEncodingException ex) {
                Logger.getLogger(Password_Reset.class.getName()).log(Level.SEVERE, null, ex);
            }
            System.out.println("jsonObjectPassword = "+jsonObjectPassword);
            client.sendData("http://localhost:8080/api/usrmgtservice/passwordreset", jsonObjectPassword);
